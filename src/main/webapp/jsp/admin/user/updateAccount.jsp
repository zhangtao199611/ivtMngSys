    ...
    <div class="admin-content-body">
        <div class="am-cf am-padding am-padding-bottom-0">
            <div class="am-fl am-cf">
                <strong class="am-text-primary am-text-lg"><h2>修改账户</h2></strong><small></small>
            </div>
        </div>
        <br>
        <FORM action="${ctx}/UserInfoController/updateAccount" method="post" onsubmit="return check()"
              enctype="multipart/form-data">
            <DIV class="control-group">
                <label class="laber_from">账户姓名</label>
                <DIV class="controls"><INPUT class="input_from" id="TureName" value="${memberInfo.memberID}" type=text disabled="disabled">
                    <P class=help-block></P></DIV>
            </DIV>

            <DIV class="control-group">
                <label class="laber_from">账户账号</label>
                <DIV class="controls"><INPUT class="input_from" id="jobID" value="${memberInfo.loginName}" type=text name="loginName" disabled="disabled" >
                    <P class=help-block></P></DIV>
            </DIV>

<%--            <DIV class="control-group">--%>
<%--                <LABEL class="laber_from">账户密码</LABEL>--%>
<%--                <DIV class="controls"><INPUT class="input_from" id="phoneNumber" value="${memberInfo.loginPassWord}"--%>
<%--                                             name="loginPassWord" placeholder=" 请修改账户密码">--%>
<%--                    <P class=help-block></P></DIV>--%>
<%--            </DIV>--%>

            <input type="text" name="userID" value="${memberInfo.userID}" style="display:none"/>
