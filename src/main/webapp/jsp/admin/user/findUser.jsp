    ...
    <div class="admin-content-body">
        <div class="am-cf am-padding am-padding-bottom-0">
            <div class="am-fl am-cf">
                <strong class="am-text-primary am-text-lg"><h2>员工详情</h2></strong><small></small>
            </div>
        </div>
        <br>
        <FORM action="${ctx}//" method="post" onsubmit="return check()"
            ...
            <DIV class="control-group">
                ...
                <DIV class="controls">
                                        <span class="input_from" style="color: #0e90d2">${memberInfo.memberName}</span>
            ...
            <DIV class="control-group">
                ...
                <DIV class="controls">
                    <span class="input_from" style="color: #0e90d2">${memberInfo.jobID}</span>
                    <P class=help-block></P></DIV>
            </DIV>
            ...
            <DIV class="control-group">
                ...
                <DIV class="controls">
                    <span class="input_from" style="color: #0e90d2">${memberInfo.phoneNumber}</span>
                    <P class=help-block></P></DIV>
            </DIV>
            ...
            <DIV class="control-group" id="td">
                <DIV>
                    ...
                    <DIV class="controls">
                        <span class="input_from" style="color: #0e90d2">${dept.deptName}</span>
