    ...
    <div class="admin-content-body">
        <div class="am-cf am-padding am-padding-bottom-0">
            <div class="am-fl am-cf">
                <strong class="am-text-primary am-text-lg"><h2>用户详情</h2></strong><small></small>
            </div>
        </div>
        <br>
        <FORM action="${ctx}/UserInfoController/returnHome?currentPage=${currentPage}" method="post" onsubmit="return check()"
              enctype="multipart/form-data">
            <DIV class="control-group">
                <label class="laber_from">用户姓名</label>
                <DIV class="controls">
                    <span class="input_from" style="color: #0e90d2">${userInfoByUserID.userID}</span>
                    <P class=help-block></P></DIV>
            </DIV>

            <DIV class="control-group">
                <label class="laber_from">用户账号</label>
                <DIV class="controls">
                    <span class="input_from" style="color: #0e90d2">${userInfoByUserID.loginName}</span>
                    <P class=help-block></P></DIV>
            </DIV>

            <DIV class="control-group">
                <LABEL class="laber_from">登录时间</LABEL>
                <DIV class="controls">
                    <span class="input_from" style="color: #0e90d2">${userInfoByUserID.latestLoginTimeStr}</span>
                    <P class=help-block></P></DIV>
            </DIV>
            ...
            <DIV class="control-group">
                ...
                <DIV class="controls">
                    <span class="input_from" style="color: #0e90d2">${userInfoByUserID.addTimeStr}</span>
                    <P class=help-block></P></DIV>
            </DIV>
            ...
            <DIV class="control-group">
                ...
                <DIV class="controls">
                    <span class="input_from" style="color: #0e90d2">
                        <c:if test="${userInfoByUserID.updateTime == null}">
                            /
                        </c:if>
                        <c:if test="${userInfoByUserID.updateTime != null}">
                            ${userInfoByUserID.updateTimeStr}
                        </c:if>
                    </span>
                    <P class=help-block></P></DIV>
            </DIV>

            <input type="text" name="userID" value="${userInfoByUserID.userID}" style="display:none"/>
            ...
            <DIV class="control-group">
                ...
                <br/>
                <DIV class="controls" ><button class="am-btn am-btn-default am-btn-xs am-text-secondary" id="button"  style="width:120px;" >返回</button></DIV>
            </DIV>
        </FORM>
    </div>
</body>
