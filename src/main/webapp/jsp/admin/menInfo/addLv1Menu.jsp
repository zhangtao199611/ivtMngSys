...
<div class="admin-content-body">
		<div class="am-cf am-padding am-padding-bottom-0">
			<div class="am-fl am-cf">
				<strong class="am-text-primary am-text-lg">新增一级菜单</strong><small></small>
			</div>
		</div>
		<hr>

    <FORM  action="${ctx}/MenInfoController/addMenInfo" method="post">
        ...
        <DIV class="control-group">
          ...
          <DIV class="control-group">
            ...
            <DIV  class="controls" ><INPUT class="input_from"    type=text id="menuUrl" name="menuFunctionUrl"placeholder=" 请输入菜单地址"><P class=help-block></P></DIV>
        </DIV>
        <br>

        <input type="text" value="1" name="menuLv" style="display:none"/>
