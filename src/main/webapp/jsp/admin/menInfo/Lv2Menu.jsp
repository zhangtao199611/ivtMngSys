	...
	<div class="admin-content-body">
		<div class="am-cf am-padding am-padding-bottom-0">
			<div class="am-fl am-cf">
				<strong class="am-text-primary am-text-lg">${menu.menuName}---二级菜单管理</strong><small></small>
			</div>
		</div>
			...
			<div class="am-u-sm-12 am-u-md-6">
				<div class="am-btn-toolbar">
					<div class="am-btn-group am-btn-group-xs">
						<a class="am-btn am-btn-default" href="${ctx}/MenInfoController/jumpAddMenInfo2?menuID=${menu.menuID}"> <span
								...
								<tr>
									...
									<td>
											<div class="am-btn-group am-btn-group-xs">
												...
												<button  type="button" onclick="window.location.href='${ctx}/MenInfoController/jumpMenInfo3List?menuID=${d.menuID}'"
													class="am-btn am-btn-default am-btn-xs am-text-secondary">
