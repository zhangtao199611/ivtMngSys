	...
	<div class="admin-content-body">
		<div class="am-cf am-padding am-padding-bottom-0">
			<div class="am-fl am-cf">
				<strong class="am-text-primary am-text-lg">菜单管理</strong><small></small>
			</div>
		</div>
			...
			<div class="am-u-sm-12 am-u-md-6">
				<div class="am-btn-toolbar">
					<div class="am-btn-group am-btn-group-xs">
						<a class="am-btn am-btn-default" href="${ctx}/MenInfoController/jumpAddMenInfo"> <span
					...
					<table class="am-table am-table-striped am-table-hover table-main">
						<thead>
							<tr>
								...
								<th class="table-title">菜单说明</th>
								<th class="table-title">菜单链接</th>
								<th class="table-set">操作</th>
							</tr>
						</thead>
						<tbody>
							<c:forEach items="${menusLv1}" var="d">
								<tr>
									<td>${d.menuName}</td>
									<td>
									...
									<td>
											<div class="am-btn-group am-btn-group-xs">
												...
												<button type="button" onclick="window.location.href='${ctx}/MenInfoController/jumpMenInfo2List?menuID=${d.menuID}'"
													class="am-btn am-btn-default am-btn-xs am-text-secondary">
													<span class="icon-th-list"></span>  查看子菜单
												</button>

												<button  type="button" onclick="javascript:if(confirm('确定删除菜单“${d.menuName}”吗?,删除该菜单将删除此菜单下的所有功能，导致功能无法使用!'));window.location.href='${ctx}/MenInfoController/deleteMenuInfo?menuID=${d.menuID}'"
													class="am-btn am-btn-default am-btn-xs am-text-secondary" style="color: red">
													<span class="icon-trash"></span>  删除菜单
												</button>
											</div>
									</td>
									<td></td>
