    ...
    <div class="admin-content-body">
        <div class="am-cf am-padding am-padding-bottom-0">
            <div class="am-fl am-cf">
                <strong class="am-text-primary am-text-lg"><h2>修改部门</h2></strong><small></small>
            </div>
        </div>
        <br>
        <FORM action="${ctx}/UserInfoController/updateDepartment" method="post" onsubmit="return check()"
            ...
            <DIV class="control-group">
                ...
                <DIV class="controls"><INPUT class="input_from" id="deptName" name="deptName" value="${deptInfoByDeptID.deptName}" type=text name="loginName" placeholder=" 请修改部门名称" >
            ...
            <DIV class="control-group">
                ...
                <DIV class="controls"><INPUT class="input_from" id="deptExplain" value="${deptInfoByDeptID.deptExplain}"
                                             name="deptExplain" placeholder=" 请修改部门名称">
                    <P class=help-block></P></DIV>
            </DIV>
