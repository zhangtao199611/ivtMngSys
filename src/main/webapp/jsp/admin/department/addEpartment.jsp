...
<div class="admin-content-body">
		<div class="am-cf am-padding am-padding-bottom-0">
			<div class="am-fl am-cf">
				<strong class="am-text-primary am-text-lg"><h2>添加部门</h2></strong><small></small>
			</div>
		</div>
		<br>
    <FORM  action="${ctx}/UserInfoController/addEpartment" method="post"  onsubmit="return checks()" enctype="multipart/form-data" >
        <DIV class="control-group">
            <label class="laber_from">部门名称</label>
            <DIV  class="controls" ><INPUT class="input_from" id="deptName"   type=text name="deptName" placeholder=" 请输入部门名称"><P class=help-block></P></DIV>
        </DIV>

        <DIV class="control-group">
            <label class="laber_from">部门说明</label>
            <DIV  class="controls" ><INPUT class="input_from" id="deptExplain"   type=text name="deptExplain" placeholder=" 请输入部门说明"><P class=help-block></P></DIV>
        </DIV>
        <br/>
        <DIV class="control-group">
