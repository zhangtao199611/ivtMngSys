    ...
    <div class="admin-content-body">
        <div class="am-cf am-padding am-padding-bottom-0">
            <div class="am-fl am-cf">
                <strong class="am-text-primary am-text-lg"><h2>岗位详情</h2></strong><small></small>
            </div>
        </div>
        <br>
        <FORM action="${ctx}/UserInfoController/updateDepartment" method="post" onsubmit="return check()"
            ...
            <DIV class="control-group">
                ...
                <DIV class="controls"><INPUT class="input_from" id="deptName" name="deptName" value="${stationInfo.deptID}" type=text name="loginName" placeholder=" 请修改部门名称"  disabled="disabled">
                    <P class=help-block></P></DIV>
            </DIV>
            <DIV class="control-group">
                <LABEL class="laber_from">岗位名称</LABEL>
                <DIV class="controls"><INPUT class="input_from" id="deptExplain" value="${stationInfo.stationName}"
                                             name="deptExplain" placeholder=" 请修改部门名称"  disabled="disabled">
                    <P class=help-block></P></DIV>
            </DIV>
<%--            <DIV class="control-group">--%>
<%--                <LABEL class="laber_from">一级菜单权限</LABEL>--%>
<%--                <DIV class="controls">--%>
<%--                    <c:forEach items="${level1Menu}" var="u">--%>
<%--                        <INPUT class="input_from" value="${u.menuName}" name="deptExplain"  disabled="disabled">--%>
<%--                    </c:forEach>--%>
...
<%--            </DIV>--%>
<%--            <DIV class="control-group">--%>
<%--                <LABEL class="laber_from">二级菜单权限</LABEL>--%>
<%--                <DIV class="controls">--%>
<%--                    <c:forEach items="${level2Menu}" var="u">--%>
<%--                        <INPUT class="input_from" value="${u.menuName}" name="deptExplain"  disabled="disabled">--%>
<%--                    </c:forEach>--%>
<%--                    <P class=help-block></P>--%>
...
<%--            </DIV>--%>
<%--            <DIV class="control-group">--%>
<%--                <LABEL class="laber_from">功能权限</LABEL>--%>
<%--                <DIV class="controls">--%>
<%--                        <textarea class="input_from" style="width: 200px"  disabled="disabled"><c:forEach items="${function}" var="u">${u}&#10;</c:forEach>--%>
<%--                        </textarea>--%>
<%--                    <P class=help-block></P>--%>
<%--                </DIV>--%>
<%--            </DIV>--%>
            <input type="text" name="deptID" value="${stationInfo.deptID}" style="display:none"/>
